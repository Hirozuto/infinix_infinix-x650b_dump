...
#BSP:modify XLWLBHLYYL-4 by shiyu.xu 20190516 start
BOOT_LOGO = hdplus1600
#BSP:modify XLWLBHLYYL-4 by shiyu.xu 20190516 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
CUSTOM_BUILD_VERNO = CY-X650B-H6110-J
...
CUSTOM_TRAN_PCBA = tran_pcba_h6110
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
#ITD: add custom macro by huanyu.ye 20190507 start
CUSTOM_SKIN_COLOR_COMPATIBLE = yes
CUSTOM_HAL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6b_mipi_raw s5k3l6ext2_mipi_raw s5k3l6ext2b_mipi_raw gc8034_mipi_raw gc8034b_mipi_raw gc8034ext2_mipi_raw gc8034ext2pblc_mipi_raw sp250a_mipi_raw sp250ab_mipi_raw gc6153_serial_yuv gc6153b_serial_yuv
CUSTOM_TRAN_CAM_MATERIAL_CODE = s5k3l6_17201563 s5k3l6_17201562 gc8034_17201572 gc8034_17201575 sp250a_17201564 gc6153_17201581
...
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l6_mipi_raw s5k3l6b_mipi_raw s5k3l6ext2_mipi_raw s5k3l6ext2b_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9718saf
#ITD: add custom macro by huanyu.ye 20190507 end
CUSTOM_HAL_MSENSORLIB = memsic
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS = dummy_lens
CUSTOM_HAL_SUB_IMGSENSOR = gc8034_mipi_raw gc8034b_mipi_raw gc8034ext2_mipi_raw gc8034ext2pblc_mipi_raw
...
#BSP: add KCEGHLYQ-44 by changliang.guo 20190613 start
CUSTOM_KERNEL_DEVICE_ORIENTATION = no
#BSP: add KCEGHLYQ-44 by changliang.guo 20190613 end
...
#ITD: add custom macro by huanyu.ye 20190507 start
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw gc8034_mipi_raw gc8034ext2_mipi_raw sp250a_mipi_raw gc6153_serial_yuv
...
#TSD£ºadd XLWLBHLYYL-3 by ang.gu 20190506 start
CUSTOM_MODEM=x650b_h6110_j1
#TSD£ºadd XLWLBHLYYL-3 by ang.gu 20190506 end
...
LCM_FAKE_HEIGHT = 0
LCM_FAKE_WIDTH = 0
#BSP:modify XLWLBHLYYL-4 by shiyu.xu 20190506 start
LCM_HEIGHT = 1600
LCM_WIDTH = 720
#BSP:modify XLWLBHLYYL-4 by shiyu.xu 20190506 end
...
#BSP:modify XLWLBHLYYL-24 by yong.guo 20190520 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP:modify XLWLBHLYYL-24 by yong.guo 20190520 end
MTK_AUDIO_NUMBER_OF_SPEAKER = 1
MTK_AUDIO_RAW_SUPPORT = yes
#modify XLWLBHLYYL-7 by yong.guo 20190508 start
MTK_AUDIO_SPEAKER_PATH = int_lo_buf
#modify XLWLBHLYYL-7 by yong.guo 20190508 end
...
MTK_BUILD_VERNO=X650B-H6110JK-P-190905V224
FINGERPRINT_BUILD_VERNO=JK-190905V224
...
#ITD: modify KCEGHLYQ-99 by shoufeng.zhao for Close HDR 20190522 start
MTK_CAM_HDR_SUPPORT = no
#ITD: modify KCEGHLYQ-99 by shoufeng.zhao for Close HDR 20190522 end
...
#BSP:add XLWLBHLYYL-14 by yongxian.wang 20190510 start
MTK_DUAL_CHARGER_SUPPORT = no
#BSP:add XLWLBHLYYL-14 by yongxian.wang 20190510 end
...
# BSP: Modify XLWLBHLYYL-10 by fengshan.wang 20190508 start
MTK_FACTORY_MODE_IN_GB2312 = no
# BSP: Modify XLWLBHLYYL-10 by fengshan.wang 20190508 end
...
MTK_FIRST_MD = 1
#TSD£ºadd XLWLBHLYYL-3 by ang.gu 20190514 start
MTK_FLIGHT_MODE_POWER_OFF_MD = yes
#TSD£ºadd XLWLBHLYYL-3 by ang.gu 20190514 end
...
#TSD£ºadd XLWLBHLYYL-3 by ang.gu 20190520 start
MTK_SIM_HOT_SWAP_COMMON_SLOT = yes
#TSD£ºadd XLWLBHLYYL-3 by ang.gu 20190520 end
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
# BSP:modify XLWLBHLYYL-2  by fangmengyao 20190426 start
MTK_UART_USB_SWITCH = yes
# BSP:modify XLWLBHLYYL-2  by fangmengyao 20190426 end
MTK_UCE_SUPPORT = no
MTK_UFS_BOOTING = no
MTK_UFS_OTP = no
...
#ITD:add cam dualcam_fullsize XLWLBHLYYL-138 by yu.wang 20190611 start
TRAN_DUALCAM_PICTURESIZE_EXTEND = yes
#ITD:add cam dualcam_fullsize XLWLBHLYYL-138 by yu.wang 20190611 end
#modify XLWLBHLYYL-7 by yong.guo 20190508 start
...
#BSP:modify XLWLBHLYYL-24 by yong.guo 20190520 end
#BSP:add XLWLBHLYHW-7 by yong.guo 20190520 start
TRAN_DIRAC_PROP_SUPPORT = yes
#BSP:add XLWLBHLYHW-7 by yong.guo 20190520 end
#BSP:add XLWLBHLYYL-592 by shuanglei.wang 20190627 start
TRAN_VOIP_BYPASS_DIRAC = yes
#BSP:add XLWLBHLYYL-592 by shuanglei.wang 20190627 end
#BSP: add custom macro by wanghanfeng 20190419 start
TRAN_SYSTEM_DEVINFO = yes
CUSTOM_TRAN_PROJECT=tran_x650b
CUSTOM_TRAN_BOM=tran_x650b_j1
...
#BSP: add custom macro by wanghanfeng 20190419 end
# BSP: add XLWLBHLYYL-10 by fengshan.wang 20190513 start
TRAN_FT_RESET = yes
TRAN_FT_REBOOT = yes
...
# BSP: add XLWLBHLYYL-10 by fengshan.wang 20190513 end
# BSP: add XLWLBHLYYL-21 by zhengbo.tang 20190514 start
TRAN_TP_SUPPORT = yes
# BSP: add XLWLBHLYYL-21 by zhengbo.tang 20190514 end
#ITD:add KCEGHLYQ-99 by shoufeng.zhao for add cam 3pty function 20190522 start
TRAN_CAMERA_FEATURE = yes
#ITD:add KCEGHLYQ-99 by shoufeng.zhao for add cam 3pty function 20190522 end

#ITD:add XLWLBHLYYL-134 by yang.li3 20190612 start
TRAN_FLASH_SLIDE_CONTROL=yes
#ITD:add XLWLBHLYYL-134 by yang.li3 20190612 end
...
#APP:remove AOSP by shuchenlin 20190816 start
TRANSSION_REMOVE_ASOP = yes
#APP:remove AOSP by shuchenlin 20190816 end
